import e from"jquery";var t=e;var DataTable=function(e,n){if(DataTable.factory(e,n))return DataTable;if(this instanceof DataTable)return t(e).DataTable(n);n=e;var i=this;var o=n===void 0;var l=this.length;o&&(n={});this.api=function(){return new r(this)};this.each((function(){var e={};var s=l>1?_fnExtend(e,n,true):n;var u,f=0;var c=this.getAttribute("id");var d=false;var p=DataTable.defaults;var h=t(this);if(this.nodeName.toLowerCase()=="table"){t(this).trigger("options.dt",s);_fnCompatOpts(p);_fnCompatCols(p.column);_fnCamelToHungarian(p,p,true);_fnCamelToHungarian(p.column,p.column,true);_fnCamelToHungarian(p,t.extend(s,h.data()),true);var g=DataTable.settings;for(f=0,u=g.length;f<u;f++){var m=g[f];if(m.nTable==this||m.nTHead&&m.nTHead.parentNode==this||m.nTFoot&&m.nTFoot.parentNode==this){var _=s.bRetrieve!==void 0?s.bRetrieve:p.bRetrieve;var b=s.bDestroy!==void 0?s.bDestroy:p.bDestroy;if(o||_)return m.oInstance;if(b){new DataTable.Api(m).destroy();break}_fnLog(m,0,"Cannot reinitialise DataTable",3);return}if(m.sTableId==this.id){g.splice(f,1);break}}if(c===null||c===""){c="DataTables_Table_"+DataTable.ext._unique++;this.id=c}var y=t.extend(true,{},DataTable.models.oSettings,{sDestroyWidth:h[0].style.width,sInstance:c,sTableId:c,colgroup:t("<colgroup>").prependTo(this),fastData:function(e,t,n){return _fnGetCellData(y,e,t,n)}});y.nTable=this;y.oInit=s;g.push(y);y.api=new r(y);y.oInstance=i.length===1?i:h.dataTable();_fnCompatOpts(s);s.aLengthMenu&&!s.iDisplayLength&&(s.iDisplayLength=Array.isArray(s.aLengthMenu[0])?s.aLengthMenu[0][0]:t.isPlainObject(s.aLengthMenu[0])?s.aLengthMenu[0].value:s.aLengthMenu[0]);s=_fnExtend(t.extend(true,{},p),s);_fnMap(y.oFeatures,s,["bPaginate","bLengthChange","bFilter","bSort","bSortMulti","bInfo","bProcessing","bAutoWidth","bSortClasses","bServerSide","bDeferRender"]);_fnMap(y,s,["ajax","fnFormatNumber","sServerMethod","aaSorting","aaSortingFixed","aLengthMenu","sPaginationType","iStateDuration","bSortCellsTop","iTabIndex","sDom","fnStateLoadCallback","fnStateSaveCallback","renderer","searchDelay","rowId","caption","layout",["iCookieDuration","iStateDuration"],["oSearch","oPreviousSearch"],["aoSearchCols","aoPreSearchCols"],["iDisplayLength","_iDisplayLength"]]);_fnMap(y.oScroll,s,[["sScrollX","sX"],["sScrollXInner","sXInner"],["sScrollY","sY"],["bScrollCollapse","bCollapse"]]);_fnMap(y.oLanguage,s,"fnInfoCallback");_fnCallbackReg(y,"aoDrawCallback",s.fnDrawCallback);_fnCallbackReg(y,"aoStateSaveParams",s.fnStateSaveParams);_fnCallbackReg(y,"aoStateLoadParams",s.fnStateLoadParams);_fnCallbackReg(y,"aoStateLoaded",s.fnStateLoaded);_fnCallbackReg(y,"aoRowCallback",s.fnRowCallback);_fnCallbackReg(y,"aoRowCreatedCallback",s.fnCreatedRow);_fnCallbackReg(y,"aoHeaderCallback",s.fnHeaderCallback);_fnCallbackReg(y,"aoFooterCallback",s.fnFooterCallback);_fnCallbackReg(y,"aoInitComplete",s.fnInitComplete);_fnCallbackReg(y,"aoPreDrawCallback",s.fnPreDrawCallback);y.rowIdFn=v(s.rowId);_fnBrowserDetect(y);var D=y.oClasses;t.extend(D,DataTable.ext.classes,s.oClasses);h.addClass(D.table);y.oFeatures.bPaginate||(s.iDisplayStart=0);if(y.iInitDisplayStart===void 0){y.iInitDisplayStart=s.iDisplayStart;y._iDisplayStart=s.iDisplayStart}var C=y.oLanguage;t.extend(true,C,s.oLanguage);if(C.sUrl){t.ajax({dataType:"json",url:C.sUrl,success:function(e){_fnCamelToHungarian(p.oLanguage,e);t.extend(true,C,e,y.oInit.oLanguage);_fnCallbackFire(y,null,"i18n",[y],true);_fnInitialise(y)},error:function(){_fnLog(y,0,"i18n file loading error",21);_fnInitialise(y)}});d=true}else _fnCallbackFire(y,null,"i18n",[y]);var S=[];var x=this.getElementsByTagName("thead");var w=_fnDetectHeader(y,x[0]);if(s.aoColumns)S=s.aoColumns;else if(w.length)for(f=0,u=w[0].length;f<u;f++)S.push(null);for(f=0,u=S.length;f<u;f++)_fnAddColumn(y);_fnApplyColumnDefs(y,s.aoColumnDefs,S,w,(function(e,t){_fnColumnOptions(y,e,t)}));var T=h.children("tbody").find("tr").eq(0);if(T.length){var a=function(e,t){return e.getAttribute("data-"+t)!==null?t:null};t(T[0]).children("th, td").each((function(e,t){var n=y.aoColumns[e];n||_fnLog(y,0,"Incorrect column count",18);if(n.mData===e){var r=a(t,"sort")||a(t,"order");var i=a(t,"filter")||a(t,"search");if(r!==null||i!==null){n.mData={_:e+".display",sort:r!==null?e+".@data-"+r:void 0,type:r!==null?e+".@data-"+r:void 0,filter:i!==null?e+".@data-"+i:void 0};n._isArrayHost=true;_fnColumnOptions(y,e)}}}))}var A=y.oFeatures;var loadedInit=function(){if(s.aaSorting===void 0){var e=y.aaSorting;for(f=0,u=e.length;f<u;f++)e[f][1]=y.aoColumns[f].asSorting[0]}_fnSortingClasses(y);_fnCallbackReg(y,"aoDrawCallback",(function(){(y.bSorted||_fnDataSource(y)==="ssp"||A.bDeferRender)&&_fnSortingClasses(y)}));var n=h.children("caption");if(y.caption){n.length===0&&(n=t("<caption/>").appendTo(h));n.html(y.caption)}if(n.length){n[0]._captionSide=n.css("caption-side");y.captionNode=n[0]}x.length===0&&(x=t("<thead/>").appendTo(h));y.nTHead=x[0];t("tr",x).addClass(D.thead.row);var r=h.children("tbody");r.length===0&&(r=t("<tbody/>").insertAfter(x));y.nTBody=r[0];var i=h.children("tfoot");i.length===0&&(i=t("<tfoot/>").appendTo(h));y.nTFoot=i[0];t("tr",i).addClass(D.tfoot.row);if(s.aaData)for(f=0;f<s.aaData.length;f++)_fnAddData(y,s.aaData[f]);else _fnDataSource(y)=="dom"&&_fnAddTr(y,t(y.nTBody).children("tr"));y.aiDisplay=y.aiDisplayMaster.slice();y.bInitialised=true;d===false&&_fnInitialise(y)};_fnCallbackReg(y,"aoDrawCallback",_fnSaveState);if(s.bStateSave){A.bStateSave=true;_fnLoadState(y,s,loadedInit)}else loadedInit()}else _fnLog(null,0,"Non-table node initialisation ("+this.nodeName+")",2)}));i=null;return this};DataTable.ext=n={
/**
...
/**
	 ...
	 *  @deprecated Since v1.10
	 */
sVersion:DataTable.version};t.extend(n,{afnFiltering:n.search,aTypes:n.type.detect,ofnSearch:n.type.search,oSort:n.type.order,afnSortData:n.order,aoFeatures:n.feature,oStdClasses:n.classes,oPagination:n.pager});t.extend(DataTable.ext.classes,{container:"dt-container",empty:{row:"dt-empty"},info:{container:"dt-info"},length:{container:"dt-length",select:"dt-input"},order:{canAsc:"dt-orderable-asc",canDesc:"dt-orderable-desc",isAsc:"dt-ordering-asc",isDesc:"dt-ordering-desc",none:"dt-orderable-none",position:"sorting_"},processing:{container:"dt-processing"},scrolling:{body:"dt-scroll-body",container:"dt-scroll",footer:{self:"dt-scroll-foot",inner:"dt-scroll-footInner"},header:{self:"dt-scroll-head",inner:"dt-scroll-headInner"}},search:{container:"dt-search",input:"dt-input"},table:"dataTable",tbody:{cell:"",row:""},thead:{cell:"",row:""},tfoot:{cell:"",row:""},paging:{active:"current",button:"dt-paging-button",container:"dt-paging",disabled:"disabled"}});var n;var r;var i;var o;var l={};var s=/[\r\n\u2028]/g;var u=/<.*?>/g;var f=/^\d{2,4}[./-]\d{1,2}[./-]\d{1,2}([T ]{1}\d{1,2}[:.]\d{2}([.:]\d{2})?)?$/;var c=new RegExp("(\\"+["/",".","*","+","?","|","(",")","[","]","{","}","\\","$","^","-"].join("|\\")+")","g");var d=/['\u00A0,$£€¥%\u2009\u202F\u20BD\u20a9\u20BArfkɃΞ]/gi;var _empty=function(e){return!e||e===true||e==="-"};var _intVal=function(e){var t=parseInt(e,10);return!isNaN(t)&&isFinite(e)?t:null};var _numToDecimal=function(e,t){l[t]||(l[t]=new RegExp(m(t),"g"));return typeof e==="string"&&t!=="."?e.replace(/\./g,"").replace(l[t],"."):e};var _isNumber=function(e,t,n){var r=typeof e;var i=r==="string";if(r==="number"||r==="bigint")return true;if(_empty(e))return true;t&&i&&(e=_numToDecimal(e,t));n&&i&&(e=e.replace(d,""));return!isNaN(parseFloat(e))&&isFinite(e)};var _isHtml=function(e){return _empty(e)||typeof e==="string"};var _htmlNumeric=function(e,t,n){if(_empty(e))return true;if(typeof e==="string"&&e.match(/<(input|select)/i))return null;var r=_isHtml(e);return r&&!!_isNumber(_stripHtml(e),t,n)||null};var _pluck=function(e,t,n){var r=[];var i=0,o=e.length;if(n!==void 0)for(;i<o;i++)e[i]&&e[i][t]&&r.push(e[i][t][n]);else for(;i<o;i++)e[i]&&r.push(e[i][t]);return r};var _pluck_order=function(e,t,n,r){var i=[];var o=0,l=t.length;if(r!==void 0)for(;o<l;o++)e[t[o]][n]&&i.push(e[t[o]][n][r]);else for(;o<l;o++)e[t[o]]&&i.push(e[t[o]][n]);return i};var _range=function(e,t){var n=[];var r;if(t===void 0){t=0;r=e}else{r=t;t=e}for(var i=t;i<r;i++)n.push(i);return n};var _removeEmpty=function(e){var t=[];for(var n=0,r=e.length;n<r;n++)e[n]&&t.push(e[n]);return t};var _stripHtml=function(e){return e.replace(u,"").replace(/<script/i,"")};var _escapeHtml=function(e){Array.isArray(e)&&(e=e.join(","));return typeof e==="string"?e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;"):e};var _normalize=function(e,t){if(typeof e!=="string")return e;var n=e.normalize("NFD");return n.length!==e.length?(t===true?e+" ":"")+n.replace(/[\u0300-\u036f]/g,""):n};
/**
 ...
 *  @memberof DataTable#oApi
 */function _fnAddColumn(e){var n=DataTable.defaults.column;var r=e.aoColumns.length;var i=t.extend({},DataTable.models.oColumn,n,{aDataSort:n.aDataSort?n.aDataSort:[r],mData:n.mData?n.mData:r,idx:r,searchFixed:{},colEl:t("<col>")});e.aoColumns.push(i);var o=e.aoPreSearchCols;o[r]=t.extend({},DataTable.models.oSearch,o[r])}
/**
 ...
 *  @param {object} settings dataTables settings object
 *  @memberof DataTable#oApi
 */function _fnColumnTypes(e){var t=e.aoColumns;var r=e.aoData;var i=DataTable.ext.type.detect;var o,l,s,u,f,c;var d,p,h;for(o=0,l=t.length;o<l;o++){d=t[o];h=[];if(!d.sType&&d._sManualType)d.sType=d._sManualType;else if(!d.sType){for(s=0,u=i.length;s<u;s++){for(f=0,c=r.length;f<c;f++)if(r[f]){h[f]===void 0&&(h[f]=_fnGetCellData(e,f,o,"type"));p=i[s](h[f],e);if(!p&&s!==i.length-2)break;if(p==="html"&&!_empty(h[f]))break}if(p){d.sType=p;break}}d.sType||(d.sType="string")}var v=n.type.className[d.sType];if(v){_columnAutoClass(e.aoHeader,o,v);_columnAutoClass(e.aoFooter,o,v)}var g=n.type.render[d.sType];if(g&&!d._render){d._render=DataTable.util.get(g);_columnAutoRender(e,o)}}}function _columnAutoRender(e,t){var n=e.aoData;for(var r=0;r<n.length;r++)if(n[r].nTr){var i=_fnGetCellData(e,r,t,"display");n[r].displayData[t]=i;_fnWriteCell(n[r].anCells[t],i)}}function _columnAutoClass(e,t,n){e.forEach((function(e){e[t]&&e[t].unique&&_addClass(e[t].cell,n)}))}
/**
 ...
 *  @returns {*} Cell data
 *  @memberof DataTable#oApi
 */function _fnGetCellData(e,t,n,r){r==="search"?r="filter":r==="order"&&(r="sort");var i=e.iDraw;var o=e.aoColumns[n];var l=e.aoData[t]._aData;var s=o.sDefaultContent;var u=o.fnGetData(l,r,{settings:e,row:t,col:n});r!=="display"&&u&&typeof u==="object"&&u.nodeName&&(u=u.innerHTML);if(u===void 0){if(e.iDrawError!=i&&s===null){_fnLog(e,0,"Requested unknown parameter "+(typeof o.mData=="function"?"{function}":"'"+o.mData+"'")+" for row "+t+", column "+n,4);e.iDrawError=i}return s}if(u!==l&&u!==null||s===null||r===void 0){if(typeof u==="function")return u.call(l)}else u=s;if(u===null&&r==="display")return"";if(r==="filter"){var f=DataTable.ext.type.search;f[o.sType]&&(u=f[o.sType](u))}return u}
/**
 ...
 * @param {*} td Cell
 * @param {*} val Value
 */function _fnWriteCell(e,n){n&&typeof n==="object"&&n.nodeName?t(e).empty().append(n):e.innerHTML=n}var p=/\[.*?\]$/;var h=/\(\)$/;
/**
 ...
 *   them from here).
 * @memberof DataTable#oApi
 */function _fnGetRowElements(e,t,n,r){var i,o,l,s=[],u=t.firstChild,f=0,c=e.aoColumns,d=e._rowReadObject;r=r!==void 0?r:d?{}:[];var attr=function(e,t){if(typeof e==="string"){var n=e.indexOf("@");if(n!==-1){var i=e.substring(n+1);var o=g(e);o(r,t.getAttribute(i))}}};var cellProcess=function(e){if(n===void 0||n===f){o=c[f];l=e.innerHTML.trim();if(o&&o._bAttrSrc){var t=g(o.mData._);t(r,l);attr(o.mData.sort,e);attr(o.mData.type,e);attr(o.mData.filter,e)}else if(d){o._setter||(o._setter=g(o.mData));o._setter(r,l)}else r[f]=l}f++};if(u)while(u){i=u.nodeName.toUpperCase();if(i=="TD"||i=="TH"){cellProcess(u);s.push(u)}u=u.nextSibling}else{s=t.anCells;for(var p=0,h=s.length;p<h;p++)cellProcess(s[p])}var v=t.firstChild?t:t.nTr;if(v){var m=v.getAttribute("id");m&&g(e.rowId)(r,m)}return{data:r,cells:s}}
/**
 ...
 */function _layoutArray(e,n,r){var i={};t.each(n,(function(e,n){if(n!==null){var r=e.replace(/([A-Z])/g," $1").split(" ");i[r[0]]||(i[r[0]]={});var o=r.length===1?"full":r[1].toLowerCase();var l=i[r[0]];var groupRun=function(e,n){t.isPlainObject(n)?Object.keys(n).map((function(t){e.push({feature:t,opts:n[t]})})):e.push(n)};l[o]&&l[o].contents||(l[o]={contents:[]});if(Array.isArray(n))for(var s=0;s<n.length;s++)groupRun(l[o].contents,n[s]);else groupRun(l[o].contents,n);Array.isArray(l[o].contents)||(l[o].contents=[l[o].contents])}}));var o=Object.keys(i).map((function(e){return e.indexOf(r)!==0?null:{name:e,val:i[e]}})).filter((function(e){return e!==null}));o.sort((function(e,t){var n=e.name.replace(/[^0-9]/g,"")*1;var r=t.name.replace(/[^0-9]/g,"")*1;return r-n}));r==="bottom"&&o.reverse();var l=[];for(var s=0,u=o.length;s<u;s++){if(o[s].val.full){l.push({full:o[s].val.full});_layoutResolve(e,l[l.length-1]);delete o[s].val.full}if(Object.keys(o[s].val).length){l.push(o[s].val);_layoutResolve(e,l[l.length-1])}}return l}
/**
 ...
 */function _layoutResolve(e,r){var getFeature=function(t,r){n.features[t]||_fnLog(e,0,"Unknown feature: "+t);return n.features[t].apply(this,[e,r])};var resolve=function(n){var i=r[n].contents;for(var o=0,l=i.length;o<l;o++)if(i[o])if(typeof i[o]==="string")i[o]=getFeature(i[o],null);else if(t.isPlainObject(i[o]))i[o]=getFeature(i[o].feature,i[o].opts);else if(typeof i[o].node==="function")i[o]=i[o].node(e);else if(typeof i[o]==="function"){var s=i[o](e);i[o]=typeof s.node==="function"?s.node():s}};t.each(r,(function(e){resolve(e)}))}
/**
 ...
 */function _fnAjaxDataSrc(e,n,r){var i="data";if(t.isPlainObject(e.ajax)&&e.ajax.dataSrc!==void 0){var o=e.ajax.dataSrc;typeof o==="string"||typeof o==="function"?i=o:o.data!==void 0&&(i=o.data)}if(!r)return i==="data"?n.aaData||n[i]:i!==""?v(i)(n):n;g(i)(n,r)}
/**
 ...
 */function _fnAjaxDataSrcParam(e,n,r){var i=t.isPlainObject(e.ajax)?e.ajax.dataSrc:null;if(i&&i[n])return v(i[n])(r);var o="";n==="draw"?o="sEcho":n==="recordsTotal"?o="iTotalRecords":n==="recordsFiltered"&&(o="iTotalDisplayRecords");return r[o]!==void 0?r[o]:r[n]}
/**
 * Filter the table using both the global filter and column based filtering
 *  @param {object} settings dataTables settings object
 *  @param {object} input search information
 *  @memberof DataTable#oApi
 */function _fnFilterComplete(e,n){var r=e.aoPreSearchCols;_fnColumnTypes(e);if(_fnDataSource(e)!="ssp"){_fnFilterData(e);e.aiDisplay=e.aiDisplayMaster.slice();_fnFilter(e.aiDisplay,e,n.search,n);t.each(e.searchFixed,(function(t,n){_fnFilter(e.aiDisplay,e,n,{})}));for(var i=0;i<r.length;i++){var o=r[i];_fnFilter(e.aiDisplay,e,o.search,o,i);t.each(e.aoColumns[i].searchFixed,(function(t,n){_fnFilter(e.aiDisplay,e,n,{},i)}))}_fnFilterCustom(e)}e.bFiltered=true;_fnCallbackFire(e,null,"search",[e])}
/**
 ...
 *  @param {object} oSettings dataTables settings object
 *  @memberof DataTable#oApi
 */function _fnFilterCustom(e){var t=DataTable.ext.search;var n=e.aiDisplay;var r,i;for(var o=0,l=t.length;o<l;o++){var s=[];for(var u=0,f=n.length;u<f;u++){i=n[u];r=e.aoData[i];t[o](e,r._aFilterData,i,r._aData,u)&&s.push(i)}n.length=0;n.push.apply(n,s)}}function _fnFilter(e,t,n,r,i){if(n!==""){var o=0;var l=typeof n==="function"?n:null;var s=n instanceof RegExp?n:l?null:_fnFilterCreateSearch(n,r);while(o<e.length){var u=t.aoData[e[o]];var f=i===void 0?u._sFilterRow:u._aFilterData[i];if(l&&!l(f,u._aData,e[o],i)||s&&!s.test(f)){e.splice(o,1);o--}o++}}}
/**
 ...
 *  @memberof DataTable#oApi
 */function _fnFilterCreateSearch(e,n){var r=[];var i=t.extend({},{boundary:false,caseInsensitive:true,exact:false,regex:false,smart:true},n);typeof e!=="string"&&(e=e.toString());e=_normalize(e);if(i.exact)return new RegExp("^"+m(e)+"$",i.caseInsensitive?"i":"");e=i.regex?e:m(e);if(i.smart){var o=e.match(/!?["\u201C][^"\u201D]+["\u201D]|[^ ]+/g)||[""];var l=o.map((function(e){var t=false;var n;if(e.charAt(0)==="!"){t=true;e=e.substring(1)}if(e.charAt(0)==='"'){n=e.match(/^"(.*)"$/);e=n?n[1]:e}else if(e.charAt(0)==="“"){n=e.match(/^\u201C(.*)\u201D$/);e=n?n[1]:e}if(t){e.length>1&&r.push("(?!"+e+")");e=""}return e.replace('"',"")}));var s=r.length?r.join(""):"";var u=i.boundary?"\\b":"";e="^(?=.*?"+u+l.join(")(?=.*?"+u)+")("+s+".)*$"}return new RegExp(e,i.caseInsensitive?"i":"")}
/**
 * Escape a string such that it can be used in a regular expression
 *  @param {string} sVal string to escape
 *  @returns {string} escaped string
 *  @memberof DataTable#oApi
 */var m=DataTable.util.escapeRegex;var _=t("<div>")[0];var b=_.textContent!==void 0;function _fnFilterData(e){var t=e.aoColumns;var n=e.aoData;var r;var i,o,l,s,u;var f=false;for(var c=0;c<n.length;c++)if(n[c]){u=n[c];if(!u._aFilterData){l=[];for(i=0,o=t.length;i<o;i++){r=t[i];if(r.bSearchable){s=_fnGetCellData(e,c,i,"filter");s===null&&(s="");typeof s!=="string"&&s.toString&&(s=s.toString())}else s="";if(s.indexOf&&s.indexOf("&")!==-1){_.innerHTML=s;s=b?_.textContent:_.innerText}s.replace&&(s=s.replace(/[\r\n\u2028]/g,""));l.push(s)}u._aFilterData=l;u._sFilterRow=l.join("  ");f=true}}return f}
/**
 * Draw the table for the first time, adding all required features
 *  @param {object} settings dataTables settings object
 *  @memberof DataTable#oApi
 */function _fnInitialise(e){var t,n=e.iInitDisplayStart;if(e.bInitialised){_fnBuildHead(e,"header");_fnBuildHead(e,"footer");_fnDrawHead(e,e.aoHeader);_fnDrawHead(e,e.aoFooter);_fnAddOptionsHtml(e);_fnSortInit(e);_colGroup(e);_fnProcessingDisplay(e,true);_fnCallbackFire(e,null,"preInit",[e],true);_fnReDraw(e);var r=_fnDataSource(e);if(r!="ssp")if(r=="ajax")_fnBuildAjax(e,{},(function(r){var i=_fnAjaxDataSrc(e,r);for(t=0;t<i.length;t++)_fnAddData(e,i[t]);e.iInitDisplayStart=n;_fnReDraw(e);_fnProcessingDisplay(e,false);_fnInitComplete(e)}),e);else{_fnInitComplete(e);_fnProcessingDisplay(e,false)}}else setTimeout((function(){_fnInitialise(e)}),200)}
/**
 * Draw the table for the first time, adding all required features
 *  @param {object} settings dataTables settings object
 *  @memberof DataTable#oApi
 ...
 *  @param {object} settings DataTables settings object
 */function _processingHtml(e){var n=e.nTable;if(e.oFeatures.bProcessing){var r=t("<div/>",{id:e.sTableId+"_processing",class:e.oClasses.processing.container,role:"status"}).html(e.oLanguage.sProcessing).append("<div><div></div><div></div><div></div><div></div></div>").insertBefore(n);t(n).on("processing.dt.DT",(function(e,t,n){r.css("display",n?"block":"none")}))}}
/**
 * Display or hide the processing indicator
 *  @param {object} settings DataTables settings object
 *  @param {bool} show Show the processing indicator (true) or not (false)
 */function _fnProcessingDisplay(e,t){_fnCallbackFire(e,null,"processing",[e,t])}
/**
 ...
 */r=function(e,t){if(!(this instanceof r))return new r(e,t);var n=[];var ctxSettings=function(e){var t=_toSettings(e);t&&n.push.apply(n,t)};if(Array.isArray(e))for(var i=0,o=e.length;i<o;i++)ctxSettings(e[i]);else ctxSettings(e);this.context=n.length>1?_unique(n):n;t&&this.push.apply(this,t);this.selector={rows:null,cols:null,opts:null};r.extend(this,this,y)};DataTable.Api=r;t.extend(r.prototype,{any:function(){return this.count()!==0},context:[],count:function(){return this.flatten().length},each:function(e){for(var t=0,n=this.length;t<n;t++)e.call(this,this[t],t,this);return this},eq:function(e){var t=this.context;return t.length>e?new r(t[e],this[e]):null},filter:function(e){var t=D.filter.call(this,e,this);return new r(this.context,t)},flatten:function(){var e=[];return new r(this.context,e.concat.apply(e,this.toArray()))},get:function(e){return this[e]},join:D.join,includes:function(e){return this.indexOf(e)!==-1},indexOf:D.indexOf,iterator:function(e,t,n,i){var o,l,s,u,f,c,d,p,h=[],v=this.context,g=this.selector;if(typeof e==="string"){i=n;n=t;t=e;e=false}for(l=0,s=v.length;l<s;l++){var m=new r(v[l]);if(t==="table"){o=n.call(m,v[l],l);o!==void 0&&h.push(o)}else if(t==="columns"||t==="rows"){o=n.call(m,v[l],this[l],l);o!==void 0&&h.push(o)}else if(t==="every"||t==="column"||t==="column-rows"||t==="row"||t==="cell"){d=this[l];t==="column-rows"&&(c=_selector_row_indexes(v[l],g.opts));for(u=0,f=d.length;u<f;u++){p=d[u];o=t==="cell"?n.call(m,v[l],p.row,p.column,l,u):n.call(m,v[l],p,l,u,c);o!==void 0&&h.push(o)}}}if(h.length||i){var _=new r(v,e?h.concat.apply([],h):h);var b=_.selector;b.rows=g.rows;b.cols=g.cols;b.opts=g.opts;return _}return this},lastIndexOf:D.lastIndexOf,length:0,map:function(e){var t=D.map.call(this,e,this);return new r(this.context,t)},pluck:function(e){var t=DataTable.util.get(e);return this.map((function(e){return t(e)}))},pop:D.pop,push:D.push,reduce:D.reduce,reduceRight:D.reduceRight,reverse:D.reverse,selector:null,shift:D.shift,slice:function(){return new r(this.context,this)},sort:D.sort,splice:D.splice,toArray:function(){return D.slice.call(this)},to$:function(){return t(this)},toJQuery:function(){return t(this)},unique:function(){return new r(this.context,_unique(this.toArray()))},unshift:D.unshift});function _api_scope(e,t,n){return function(){var i=t.apply(e||this,arguments);r.extend(i,i,n.methodExt);return i}}function _api_find(e,t){for(var n=0,r=e.length;n<r;n++)if(e[n].name===t)return e[n];return null}window.__apiStruct=y;r.extend=function(e,t,n){if(n.length&&t&&(t instanceof r||t.__dt_wrapper)){var i,o,l;for(i=0,o=n.length;i<o;i++){l=n[i];t[l.name]=l.type==="function"?_api_scope(e,l.val,l):l.type==="object"?{}:l.val;t[l.name].__dt_wrapper=true;r.extend(e,t[l.name],l.propExt)}}};r.register=i=function(e,n){if(Array.isArray(e))for(var i=0,o=e.length;i<o;i++)r.register(e[i],n);else{var l,s,u,f,c=e.split("."),d=y;for(l=0,s=c.length;l<s;l++){f=c[l].indexOf("()")!==-1;u=f?c[l].replace("()",""):c[l];var p=_api_find(d,u);if(!p){p={name:u,val:{},methodExt:[],propExt:[],type:"object"};d.push(p)}if(l===s-1){p.val=n;p.type=typeof n==="function"?"function":t.isPlainObject(n)?"object":"other"}else d=f?p.methodExt:p.propExt}}};r.registerPlural=o=function(e,t,n){r.register(e,n);r.register(t,(function(){var e=n.apply(this,arguments);return e===this?this:e instanceof r?e.length?Array.isArray(e[0])?new r(e.context,e[0]):e[0]:void 0:e}))};
/**
 ...
 */DataTable.use=function(e,n){if(n==="lib"||e.fn)t=e;else if(n=="win"||e.document){window=e;document=e.document}else n!=="datetime"&&e.type!=="DateTime"||(DataTable.DateTime=e)};
/**
...
/**
	 ...
	 *  @deprecated Since v1.10
	 */
sVersion:DataTable.version};t.extend(n,{afnFiltering:n.search,aTypes:n.type.detect,ofnSearch:n.type.search,oSort:n.type.order,afnSortData:n.order,aoFeatures:n.feature,oStdClasses:n.classes,oPagination:n.pager});t.extend(DataTable.ext.classes,{container:"dt-container",empty:{row:"dt-empty"},info:{container:"dt-info"},length:{container:"dt-length",select:"dt-input"},order:{canAsc:"dt-orderable-asc",canDesc:"dt-orderable-desc",isAsc:"dt-ordering-asc",isDesc:"dt-ordering-desc",none:"dt-orderable-none",position:"sorting_"},processing:{container:"dt-processing"},scrolling:{body:"dt-scroll-body",container:"dt-scroll",footer:{self:"dt-scroll-foot",inner:"dt-scroll-footInner"},header:{self:"dt-scroll-head",inner:"dt-scroll-headInner"}},search:{container:"dt-search",input:"dt-input"},table:"dataTable",tbody:{cell:"",row:""},thead:{cell:"",row:""},tfoot:{cell:"",row:""},paging:{active:"current",button:"dt-paging-button",container:"dt-paging",disabled:"disabled"}});var A=DataTable.ext.pager;t.extend(A,{simple:function(){return["previous","next"]},full:function(){return["first","previous","next","last"]},numbers:function(){return["numbers"]},simple_numbers:function(){return["previous","numbers","next"]},full_numbers:function(){return["first","previous","numbers","next","last"]},first_last:function(){return["first","last"]},first_last_numbers:function(){return["first","numbers","last"]},_numbers:_pagingNumbers,numbers_length:7});t.extend(true,DataTable.ext.renderer,{pagingButton:{_:function(e,n,r,i,o){var l=e.oClasses.paging;var s=[l.button];var u;i&&s.push(l.active);o&&s.push(l.disabled);u=n==="ellipsis"?t('<span class="ellipsis"></span>').html(r)[0]:t("<button>",{class:s.join(" "),role:"link",type:"button"}).html(r);return{display:u,clicker:u}}},pagingContainer:{_:function(e,t){return t}}});var _filterString=function(e,t){return function(n){if(_empty(n)||typeof n!=="string")return n;n=n.replace(s," ");e&&(n=_stripHtml(n));t&&(n=_normalize(n,false));return n}};function __mldFnName(e){return e.replace(/[\W]/g,"_")}function __mld(e,t,n,r,i){return window.moment?e[t](i):window.luxon?e[n](i):r?e[r](i):e}var F=false;function __mldObj(e,t,n){var r;if(window.moment){r=window.moment.utc(e,t,n,true);if(!r.isValid())return null}else if(window.luxon){r=t&&typeof e==="string"?window.luxon.DateTime.fromFormat(e,t):window.luxon.DateTime.fromISO(e);if(!r.isValid)return null;r.setLocale(n)}else if(t){F||alert("DataTables warning: Formatted date without Moment.js or Luxon - https://datatables.net/tn/17");F=true}else r=new Date(e);return r}function __mlHelper(e){return function(t,n,r,i){if(arguments.length===0){r="en";n=null;t=null}else if(arguments.length===1){r="en";n=t;t=null}else if(arguments.length===2){r=n;n=t;t=null}var o="datetime"+(n?"-"+__mldFnName(n):"");DataTable.ext.type.order[o]||DataTable.type(o,{detect:function(e){return e===o&&o},order:{pre:function(e){return e.valueOf()}},className:"dt-right"});return function(l,s){if(l===null||l===void 0)if(i==="--now"){var u=new Date;l=new Date(Date.UTC(u.getFullYear(),u.getMonth(),u.getDate(),u.getHours(),u.getMinutes(),u.getSeconds()))}else l="";if(s==="type")return o;if(l==="")return s!=="sort"?"":__mldObj("0000-01-01 00:00:00",null,r);if(n!==null&&t===n&&s!=="sort"&&s!=="type"&&!(l instanceof Date))return l;var f=__mldObj(l,t,r);if(f===null)return l;if(s==="sort")return f;var c=n===null?__mld(f,"toDate","toJSDate","")[e]():__mld(f,"format","toFormat","toISOString",n);return s==="display"?_escapeHtml(c):c}}}var I=",";var L=".";if(window.Intl!==void 0)try{var R=(new Intl.NumberFormat).formatToParts(100000.1);for(var j=0;j<R.length;j++)R[j].type==="group"?I=R[j].value:R[j].type==="decimal"&&(L=R[j].value)}catch(e){}DataTable.datetime=function(e,t){var n="datetime-detect-"+__mldFnName(e);t||(t="en");DataTable.ext.type.order[n]||DataTable.type(n,{detect:function(r){var i=__mldObj(r,e,t);return!(r!==""&&!i)&&n},order:{pre:function(n){return __mldObj(n,e,t)||0}},className:"dt-right"})};DataTable.render={date:__mlHelper("toLocaleDateString"),datetime:__mlHelper("toLocaleString"),time:__mlHelper("toLocaleTimeString"),number:function(e,t,n,r,i){e!==null&&e!==void 0||(e=I);t!==null&&t!==void 0||(t=L);return{display:function(o){if(typeof o!=="number"&&typeof o!=="string")return o;if(o===""||o===null)return o;var l=o<0?"-":"";var s=parseFloat(o);var u=Math.abs(s);if(u>=1e11||u<1e-4&&u!==0){var f=s.toExponential(n).split(/e\+?/);return f[0]+" x 10<sup>"+f[1]+"</sup>"}if(isNaN(s))return _escapeHtml(o);s=s.toFixed(n);o=Math.abs(s);var c=parseInt(o,10);var d=n?t+(o-c).toFixed(n).substring(2):"";c===0&&parseFloat(d)===0&&(l="");return l+(r||"")+c.toString().replace(/\B(?=(\d{3})+(?!\d))/g,e)+d+(i||"")}}},text:function(){return{display:_escapeHtml,filter:_escapeHtml}}};var P=DataTable.ext.type;DataTable.type=function(e,t,n){if(!t)return{className:P.className[e],detect:P.detect.find((function(t){return t.name===e})),order:{pre:P.order[e+"-pre"],asc:P.order[e+"-asc"],desc:P.order[e+"-desc"]},render:P.render[e],search:P.search[e]};var setProp=function(t,n){P[t][e]=n};var setDetect=function(t){var cb=function(n,r){var i=t(n,r);return i===true?e:i};Object.defineProperty(cb,"name",{value:e});var n=P.detect.findIndex((function(t){return t.name===e}));n===-1?P.detect.unshift(cb):P.detect.splice(n,1,cb)};var setOrder=function(t){P.order[e+"-pre"]=t.pre;P.order[e+"-asc"]=t.asc;P.order[e+"-desc"]=t.desc};if(n===void 0){n=t;t=null}if(t==="className")setProp("className",n);else if(t==="detect")setDetect(n);else if(t==="order")setOrder(n);else if(t==="render")setProp("render",n);else if(t==="search")setProp("search",n);else if(!t){n.className&&setProp("className",n.className);n.detect!==void 0&&setDetect(n.detect);n.order&&setOrder(n.order);n.render!==void 0&&setProp("render",n.render);n.search!==void 0&&setProp("search",n.search)}};DataTable.types=function(){return P.detect.map((function(e){return e.name}))};DataTable.type("string",{detect:function(){return"string"},order:{pre:function(e){return _empty(e)?"":typeof e==="string"?e.toLowerCase():e.toString?e.toString():""}},search:_filterString(false,true)});DataTable.type("html",{detect:function(e){return _empty(e)||typeof e==="string"&&e.indexOf("<")!==-1?"html":null},order:{pre:function(e){return _empty(e)?"":e.replace?_stripHtml(e).trim().toLowerCase():e+""}},search:_filterString(true,true)});DataTable.type("date",{className:"dt-type-date",detect:function(e){if(e&&!(e instanceof Date)&&!f.test(e))return null;var t=Date.parse(e);return t!==null&&!isNaN(t)||_empty(e)?"date":null},order:{pre:function(e){var t=Date.parse(e);return isNaN(t)?-Infinity:t}}});DataTable.type("html-num-fmt",{className:"dt-type-numeric",detect:function(e,t){var n=t.oLanguage.sDecimal;return _htmlNumeric(e,n,true)?"html-num-fmt":null},order:{pre:function(e,t){var n=t.oLanguage.sDecimal;return __numericReplace(e,n,u,d)}},search:_filterString(true,true)});DataTable.type("html-num",{className:"dt-type-numeric",detect:function(e,t){var n=t.oLanguage.sDecimal;return _htmlNumeric(e,n)?"html-num":null},order:{pre:function(e,t){var n=t.oLanguage.sDecimal;return __numericReplace(e,n,u)}},search:_filterString(true,true)});DataTable.type("num-fmt",{className:"dt-type-numeric",detect:function(e,t){var n=t.oLanguage.sDecimal;return _isNumber(e,n,true)?"num-fmt":null},order:{pre:function(e,t){var n=t.oLanguage.sDecimal;return __numericReplace(e,n,d)}}});DataTable.type("num",{className:"dt-type-numeric",detect:function(e,t){var n=t.oLanguage.sDecimal;return _isNumber(e,n)?"num":null},order:{pre:function(e,t){var n=t.oLanguage.sDecimal;return __numericReplace(e,n)}}});var __numericReplace=function(e,t,n,r){if(e!==0&&(!e||e==="-"))return-Infinity;var i=typeof e;if(i==="number"||i==="bigint")return e;t&&(e=_numToDecimal(e,t));if(e.replace){n&&(e=e.replace(n,""));r&&(e=e.replace(r,""))}return e*1};t.extend(true,DataTable.ext.renderer,{footer:{_:function(e,t,n){t.addClass(n.tfoot.cell)}},header:{_:function(e,n,r){n.addClass(r.thead.cell);e.oFeatures.bSort||n.addClass(r.order.none);var i=e.bSortCellsTop;var o=n.closest("thead").find("tr");var l=n.parent().index();n.attr("data-dt-order")==="disable"||n.parent().attr("data-dt-order")==="disable"||i===true&&l!==0||i===false&&l!==o.length-1||t(e.nTable).on("order.dt.DT",(function(t,i,o){if(e===i){var l=r.order;var s=i.api.columns(n);var u=e.aoColumns[s.flatten()[0]];var f=s.orderable().includes(true);var c="";var d=s.indexes();var p=s.orderable(true).flatten();var h=","+o.map((function(e){return e.col})).join(",")+",";n.removeClass(l.isAsc+" "+l.isDesc).toggleClass(l.none,!f).toggleClass(l.canAsc,f&&p.includes("asc")).toggleClass(l.canDesc,f&&p.includes("desc"));var v=h.indexOf(","+d.toArray().join(",")+",");if(v!==-1){var g=s.order();n.addClass(g.includes("asc")?l.isAsc:""+g.includes("desc")?l.isDesc:"")}if(v===0){var m=o[0];var _=u.asSorting;n.attr("aria-sort",m.dir==="asc"?"ascending":"descending");c=_[m.index+1]?"Reverse":"Remove"}else n.removeAttr("aria-sort");n.attr("aria-label",f?u.ariaTitle+i.api.i18n("oAria.orderable"+c):u.ariaTitle);if(f){n.find(".dt-column-title").attr("role","button");n.attr("tabindex",0)}}}))}},layout:{_:function(e,n,r){var i=t("<div/>").addClass("dt-layout-row").appendTo(n);t.each(r,(function(e,n){var r=n.table?"":"dt-"+e+" ";n.table&&i.addClass("dt-layout-table");t("<div/>").attr({id:n.id||null,class:"dt-layout-cell "+r+(n.className||"")}).append(n.contents).appendTo(i)}))}}});DataTable.feature={};DataTable.feature.register=function(e,t,r){DataTable.ext.features[e]=t;r&&n.feature.push({cFeature:r,fnInit:t})};DataTable.feature.register("info",(function(e,n){if(!e.oFeatures.bInfo)return null;var r=e.oLanguage,i=e.sTableId,o=t("<div/>",{class:e.oClasses.info.container});n=t.extend({callback:r.fnInfoCallback,empty:r.sInfoEmpty,postfix:r.sInfoPostFix,search:r.sInfoFiltered,text:r.sInfo},n);e.aoDrawCallback.push((function(e){_fnUpdateInfo(e,n,o)}));if(!t("#"+i+"_info",e.nWrapper).length){o.attr({"aria-live":"polite",id:i+"_info",role:"status"});t(e.nTable).attr("aria-describedby",i+"_info")}return o}),"i");
/**
 * Update the information elements in the display
 *  @param {object} settings dataTables settings object
 *  @memberof DataTable#oApi
 */function _fnUpdateInfo(e,t,n){var r=e._iDisplayStart+1,i=e.fnDisplayEnd(),o=e.fnRecordsTotal(),l=e.fnRecordsDisplay(),s=l?t.text:t.empty;l!==o&&(s+=" "+t.search);s+=t.postfix;s=_fnMacros(e,s);t.callback&&(s=t.callback.call(e.oInstance,e,r,i,o,l,s));n.html(s);_fnCallbackFire(e,null,"info",[e,n[0],s])}var k=0;DataTable.feature.register("search",(function(e,n){if(!e.oFeatures.bFilter)return null;var r=e.oClasses.search;var i=e.sTableId;var o=e.oLanguage;var l=e.oPreviousSearch;var s='<input type="search" class="'+r.input+'"/>';n=t.extend({placeholder:o.sSearchPlaceholder,text:o.sSearch},n);n.text.indexOf("_INPUT_")===-1&&(n.text+="_INPUT_");n.text=_fnMacros(e,n.text);var u=n.text.match(/_INPUT_$/);var f=n.text.match(/^_INPUT_/);var c=n.text.replace(/_INPUT_/,"");var d="<label>"+n.text+"</label>";f?d="_INPUT_<label>"+c+"</label>":u&&(d="<label>"+c+"</label>_INPUT_");var p=t("<div>").addClass(r.container).append(d.replace(/_INPUT_/,s));p.find("label").attr("for","dt-search-"+k);p.find("input").attr("id","dt-search-"+k);k++;var searchFn=function(t){var n=this.value;if((!l.return||t.key==="Enter")&&n!=l.search){l.search=n;_fnFilterComplete(e,l);e._iDisplayStart=0;_fnDraw(e)}};var h=e.searchDelay!==null?e.searchDelay:0;var v=t("input",p).val(l.search).attr("placeholder",n.placeholder).on("keyup.DT search.DT input.DT paste.DT cut.DT",h?DataTable.util.debounce(searchFn,h):searchFn).on("mouseup.DT",(function(e){setTimeout((function(){searchFn.call(v[0],e)}),10)})).on("keypress.DT",(function(e){if(e.keyCode==13)return false})).attr("aria-controls",i);t(e.nTable).on("search.dt.DT",(function(t,n){e===n&&v[0]!==document.activeElement&&v.val(typeof l.search!=="function"?l.search:"")}));return p}),"f");DataTable.feature.register("paging",(function(e,n){if(!e.oFeatures.bPaginate)return null;n=t.extend({numbers:DataTable.ext.pager.numbers_length,type:e.sPaginationType},n);var r=t("<div/>").addClass(e.oClasses.paging.container+" paging_"+n.type);var draw=function(){_pagingDraw(e,r,n)};e.aoDrawCallback.push(draw);t(e.nTable).on("column-sizing.dt.DT",draw);return r}),"p");function _pagingDraw(e,n,r){if(e._bInitComplete){var i=DataTable.ext.pager[r.type],o=e.oLanguage.oAria.paginate||{},l=e._iDisplayStart,s=e._iDisplayLength,u=e.fnRecordsDisplay(),f=s===-1,c=f?0:Math.ceil(l/s),d=f?1:Math.ceil(u/s),p=i().map((function(e){return e==="numbers"?_pagingNumbers(c,d,r.numbers):e})).flat();var h=[];for(var v=0;v<p.length;v++){var g=p[v];var m=_pagingButtonInfo(e,g,c,d);var _=_fnRenderer(e,"pagingButton")(e,g,m.display,m.active,m.disabled);t(_.clicker).attr({"aria-controls":e.sTableId,"aria-disabled":m.disabled?"true":null,"aria-current":m.active?"page":null,"aria-label":o[g],"data-dt-idx":g,tabIndex:m.disabled?-1:e.iTabIndex});typeof g!=="number"&&t(_.clicker).addClass(g);_fnBindAction(_.clicker,{action:g},(function(t){t.preventDefault();_fnPageChange(e,t.data.action,true)}));h.push(_.display)}var b=_fnRenderer(e,"pagingContainer")(e,h);var y=n.find(document.activeElement).data("dt-idx");n.empty().append(b);y!==void 0&&n.find("[data-dt-idx="+y+"]").trigger("focus");h.length&&r.numbers>1&&t(n).height()>=t(h[0]).outerHeight()*2-10&&_pagingDraw(e,n,t.extend({},r,{numbers:r.numbers-2}))}}
/**
 ...
 */function _pagingNumbers(e,t,n){var r=[],i=Math.floor(n/2);if(t<=n)r=_range(0,t);else if(n===1)r=[e];else if(n===3)if(e<=1)r=[0,1,"ellipsis"];else if(e>=t-2){r=_range(t-2,t);r.unshift("ellipsis")}else r=["ellipsis",e,"ellipsis"];else if(e<=i){r=_range(0,n-2);r.push("ellipsis",t-1)}else if(e>=t-1-i){r=_range(t-(n-2),t);r.unshift(0,"ellipsis")}else{r=_range(e-i+2,e+i-1);r.push("ellipsis",t-1);r.unshift(0,"ellipsis")}return r}var N=0;DataTable.feature.register("pageLength",(function(e,n){var r=e.oFeatures;if(!r.bPaginate||!r.bLengthChange)return null;n=t.extend({menu:e.aLengthMenu,text:e.oLanguage.sLengthMenu},n);var i,o=e.oClasses.length,l=e.sTableId,s=n.menu,u=[],f=[];if(Array.isArray(s[0])){u=s[0];f=s[1]}else for(i=0;i<s.length;i++)if(t.isPlainObject(s[i])){u.push(s[i].value);f.push(s[i].label)}else{u.push(s[i]);f.push(s[i])}var c=n.text.match(/_MENU_$/);var d=n.text.match(/^_MENU_/);var p=n.text.replace(/_MENU_/,"");var h="<label>"+n.text+"</label>";d?h="_MENU_<label>"+p+"</label>":c&&(h="<label>"+p+"</label>_MENU_");var v=t("<div/>").addClass(o.container).append(h.replace("_MENU_","<span></span>"));var g=[];v.find("label")[0].childNodes.forEach((function(e){e.nodeType===Node.TEXT_NODE&&g.push({el:e,text:e.textContent})}));var updateEntries=function(t){g.forEach((function(n){n.el.textContent=_fnMacros(e,n.text,t)}))};var m=t("<select/>",{name:l+"_length","aria-controls":l,class:o.select});for(i=0;i<u.length;i++)m[0][i]=new Option(typeof f[i]==="number"?e.fnFormatNumber(f[i]):f[i],u[i]);v.find("label").attr("for","dt-length-"+N);m.attr("id","dt-length-"+N);N++;v.find("span").replaceWith(m);t("select",v).val(e._iDisplayLength).on("change.DT",(function(){_fnLengthChange(e,t(this).val());_fnDraw(e)}));t(e.nTable).on("length.dt.DT",(function(n,r,i){if(e===r){t("select",v).val(i);updateEntries(i)}}));updateEntries(e._iDisplayLength);return v}),"l");t.fn.dataTable=DataTable;DataTable.$=t;t.fn.dataTableSettings=DataTable.settings;t.fn.dataTableExt=DataTable.ext;t.fn.DataTable=function(e){return t(this).dataTable(e).api()};t.each(DataTable,(function(e,n){t.fn.DataTable[e]=n}));export{DataTable as default};
