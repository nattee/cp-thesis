...
class VariablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create variable" do
    assert_difference("Variable.count") do
      post variables_url, params: { variable: { description: @variable.description, kind: @variable.kind, name: @variable.name, resolution: @variable.resolution, unit: @variable.unit } }
    end
  ...
  test "should update variable" do
    patch variable_url(@variable), params: { variable: { description: @variable.description, kind: @variable.kind, name: @variable.name, resolution: @variable.resolution, unit: @variable.unit } }
