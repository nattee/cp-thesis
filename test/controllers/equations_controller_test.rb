...
class EquationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create equation" do
    assert_difference("Equation.count") do
      post equations_url, params: { equation: { name: @equation.name, resolution: @equation.resolution, variable_id: @equation.variable_id } }
    end
  ...
  test "should update equation" do
    patch equation_url(@equation), params: { equation: { name: @equation.name, resolution: @equation.resolution, variable_id: @equation.variable_id } }
